...
extension TMDBClient {
    ...
    */
    ...
    private func getRequestToken(_ completionHandlerForToken: (success: Bool, requestToken: String?, errorString: String?) -> Void) {
        ...
        /* 2. Make the request */
        taskForGETMethod(method: Methods.AuthenticationTokenNew, parameters: parameters) {
            (results, error) in
    ...
    private func getSessionID(_ requestToken: String?, completionHandlerForSession: (success: Bool, sessionID: String?, errorString: String?) -> Void) {
        ...
        /* 2. Make the request */
        taskForGETMethod(method: Methods.AuthenticationSessionNew, parameters: parameters) {
            (results, error) in
    ...
    private func getUserID(_ completionHandlerForUserID: (success: Bool, userID: Int?, errorString: String?) -> Void) {
        ...
        /* 2. Make the request */
        taskForGETMethod(method: Methods.Account, parameters: parameters) {
            (results, error) in
    ...
    func getFavoriteMovies(_ completionHandlerForFavMovies: (result: [TMDBMovie]?, error: NSError?) -> Void) {
        ...
        /* 2. Make the request */
        taskForGETMethod(method: mutableMethod, parameters: parameters) {
            (results, error) in
    ...
    func getMoviesForSearchString(_ searchString: String, completionHandlerForMovies: (result: [TMDBMovie]?, error: NSError?) -> Void) -> URLSessionDataTask? {
        ...
        /* 2. Make the request */
        let task = taskForGETMethod(method: Methods.SearchMovie, parameters: parameters) {
            (results, error) in
    ...
    func postToFavorites(_ movie: TMDBMovie, favorite: Bool, completionHandlerForFavorite: (result: Int?, error: NSError?) -> Void)  {
        ...
        /* 2. Make the request */
        taskForPOSTMethod(method: mutableMethod, parameters: parameters, jsonBody: jsonBody) {
            (results, error) in
            ...
            if let error = error {
                ...
                if let responseStatusCode = results?[TMDBClient.JSONResponseKeys.StatusCode] as? Int {
                    completionHandlerForFavorite(result: responseStatusCode, error: nil)
                } else{
    ...
    func postToWatchlist(_ movie: TMDBMovie, watchlist: Bool, completionHandlerForWatchlist: (result: Int?, error: NSError?) -> Void) {
        ...
        taskForPOSTMethod(method: mutableMethod, parameters: parameters, jsonBody: jsonBody) {
            ...
            if let error = error {
                ...
                if let responseStatusCode = results?[TMDBClient.JSONResponseKeys.StatusCode] as? Int {
                    completionHandlerForWatchlist(result: responseStatusCode, error: nil)
                } else{
